...
const (
	authorityAddress = "pica12smx2wdlyttvyzvzg54y2vnqwq2qjate0ww798" //NOTE: the address is hardfix according to locanode.sh file
)
...
func (appKeepers *AppKeepers) InitNormalKeepers(
	...
	*/
	...
	appKeepers.Wasm08Keeper = wasm08Keeper.NewKeeper(appCodec, appKeepers.keys[wasm08types.StoreKey], authtypes.NewModuleAddress(govtypes.ModuleName).String(), homePath, &appKeepers.IBCKeeper.ClientKeeper)
