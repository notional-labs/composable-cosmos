...
func (appKeepers *AppKeepers) InitNormalKeepers(
	...
	*/
	...
	appKeepers.Wasm08Keeper = wasm08Keeper.NewKeeper(appCodec, appKeepers.keys[wasm08types.StoreKey], "centauri1hj5fveer5cjtn4wd6wstzugjfdxzl0xpzxlwgs", homePath, &appKeepers.IBCKeeper.ClientKeeper)
